...
import ErrorEmailValidationEntityCreation from '../../../../Shared/errors/emailValidationEntityCreation';
      ...
      async () =>
        new Validation({
          ...
          operationToValidateType:
            OperationToValidateTypeEnum.EMAIL_CONFIRMATION,
          expirationIn: 3,
        }),
    ).rejects.toStrictEqual(
      new ErrorEmailValidationEntityCreation(errorMessage),
    );
  });
});
